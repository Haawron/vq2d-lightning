...
# 320ss
python -Bm ltvu.preprocess --splits 'test_unannotated' --short-side 320 --whole --raw_clips_dir '/data/datasets/ego4d_data/v2/clips' --ego4d_dir '/data/datasets/ego4d_data/v2'
